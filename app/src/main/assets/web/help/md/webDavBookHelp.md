...
虽然阅读主要是用来看网络小说的工具，但也支持 TXT、EPUB、UMD、PDF、MOBI、AZW/AZW3、CBZ 等本地书籍格式，并可处理 ZIP、RAR、7Z 容器中的受支持书籍。
...
- 第三方 WebDAV 服务的套餐、流量和请求频率限制会变化。上传大量书籍前请查看所用服务的当前规则，避免超出配额影响备份和进度同步。
