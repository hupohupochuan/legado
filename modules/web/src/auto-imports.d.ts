...
declare global {
  ...
  const effectScope: typeof import('vue').effectScope
  const emptyReplaceRule: typeof import('./store/replaceRuleStore').emptyReplaceRule
  ...
  const useReplaceRuleStore: typeof import('./store/replaceRuleStore').useReplaceRuleStore
